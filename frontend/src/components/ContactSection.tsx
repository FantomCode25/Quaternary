  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      details: "khushisaritaagarwal@gmail.com",
      link: "mailto:khushisaritaagarwal@gmail.com",
    },
    {
      icon: <FaPhone className="text-2xl text-green-500" />,
      title: "Phone",
      details: "+91-7321896070",
      link: "tel:+91-7321896070",
    },
    {
      ...
      link: "https://maps.app.goo.gl/vEzD1orjp6cyJeCJ9",
    },
  ];
